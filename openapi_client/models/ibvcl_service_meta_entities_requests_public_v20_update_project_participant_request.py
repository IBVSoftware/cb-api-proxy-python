...
class IBVCLServiceMetaEntitiesRequestsPublicV20UpdateProjectParticipantRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uniqueDeviceId", "username", "permission"]
