...
class IBVCLServiceMetaEntitiesResponsesPublicCommonGetUserInfoCallResult(BaseModel):
    """
    ...
    result: Optional[IBVCLServiceMetaEntitiesAuthenticatedUserExt] = None
    __properties: ClassVar[List[str]] = ["errorCode", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": IBVCLServiceMetaEntitiesAuthenticatedUserExt.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
