...
class IBVCLServiceMetaEntitiesAuthenticatedUserExt(BaseModel):
    """
    IBVCLServiceMetaEntitiesAuthenticatedUserExt
    """ # noqa: E501
    date_created: Optional[datetime] = Field(default=None, alias="dateCreated")
    date_last_updated: Optional[datetime] = Field(default=None, alias="dateLastUpdated")
    date_last_activity: Optional[datetime] = Field(default=None, alias="dateLastActivity")
    __properties: ClassVar[List[str]] = ["dateCreated", "dateLastUpdated", "dateLastActivity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if date_last_updated (nullable) is None
        # and model_fields_set contains the field
        if self.date_last_updated is None and "date_last_updated" in self.model_fields_set:
            _dict['dateLastUpdated'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dateLastUpdated": obj.get("dateLastUpdated"),
