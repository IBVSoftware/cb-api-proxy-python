...
class IBVCLServiceMetaEntitiesRequestsPublicV20UpdateProjectRequest(BaseModel):
    """
    IBVCLServiceMetaEntitiesRequestsPublicV20UpdateProjectRequest
    """ # noqa: E501
    unique_device_id: Optional[StrictStr] = Field(default=None, alias="uniqueDeviceId")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["uniqueDeviceId", "description"]
