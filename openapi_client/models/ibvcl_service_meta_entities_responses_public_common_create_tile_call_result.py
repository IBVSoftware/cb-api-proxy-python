...
class IBVCLServiceMetaEntitiesResponsesPublicCommonCreateTileCallResult(BaseModel):
    """
    ...
    tile: Optional[IBVCLServiceMetaEntitiesTileStatus] = None
    __properties: ClassVar[List[str]] = ["errorCode", "tile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tile": IBVCLServiceMetaEntitiesTileStatus.from_dict(obj["tile"]) if obj.get("tile") is not None else None
        })
        return _obj
