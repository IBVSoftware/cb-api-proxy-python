...
class IBVCLServiceMetaEntitiesRequestsPublicV20AddSubscriptionUserRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uniqueDeviceId", "username", "status", "permission"]
