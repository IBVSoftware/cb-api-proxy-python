...
class IBVCLServiceMetaEntitiesResponsesPublicCommonGetParticipatingProjectsCallResult(BaseModel):
    """
    ...
    results: Optional[List[IBVCLServiceMetaEntitiesResponsesPublicCommonGetParticipatingProjectsItem]] = None
    __properties: ClassVar[List[str]] = ["errorCode", "pageSize", "pageNumber", "totalCount", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [IBVCLServiceMetaEntitiesResponsesPublicCommonGetParticipatingProjectsItem.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
