...
class IBVCLServiceMetaEntitiesResponsesPublicCommonGetProjectCallResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["errorCode", "project", "thumbnailUrl", "permission", "isLicensed", "lastAccessDate", "numberOfParticipants"]
