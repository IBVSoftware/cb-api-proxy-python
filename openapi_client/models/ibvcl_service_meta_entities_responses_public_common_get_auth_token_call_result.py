...
class IBVCLServiceMetaEntitiesResponsesPublicCommonGetAuthTokenCallResult(BaseModel):
    """
    ...
    authorization_token: Optional[StrictStr] = Field(default=None, alias="authorizationToken")
    expires_in: Optional[StrictInt] = Field(default=None, alias="expiresIn")
    __properties: ClassVar[List[str]] = ["errorCode", "authorizationToken", "expiresIn"]
