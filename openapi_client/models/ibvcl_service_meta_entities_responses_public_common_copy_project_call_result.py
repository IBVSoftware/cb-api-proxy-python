...
class IBVCLServiceMetaEntitiesResponsesPublicCommonCopyProjectCallResult(BaseModel):
    """
    ...
    status: Optional[IBVCLServiceMetaEntitiesStateMachineStatus] = None
    __properties: ClassVar[List[str]] = ["errorCode", "operationId", "projectId", "status"]
