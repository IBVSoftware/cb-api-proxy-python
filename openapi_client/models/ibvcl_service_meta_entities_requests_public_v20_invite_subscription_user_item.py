...
class IBVCLServiceMetaEntitiesRequestsPublicV20InviteSubscriptionUserItem(BaseModel):
    """
    IBVCLServiceMetaEntitiesRequestsPublicV20InviteSubscriptionUserItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["username", "firstName", "lastName", "companyName", "phoneNumber", "language"]
